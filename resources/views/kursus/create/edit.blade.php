        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <main class="form-registration m-auto">
                    <form action="/mycourse/{{ $course->id }}/{{ $datas->id }}" method="POST">
                        @method('put')
                        @csrf
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control @error('course_title') is-invalid @enderror"
                                placeholder="Judul" name="course_title" value="{{ $datas->course_title }}">
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <input id="body" type="hidden" name="course_content"
                                value="{{ $datas->course_content }}">
